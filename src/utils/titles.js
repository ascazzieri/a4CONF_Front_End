...
export const pcb_ready_desc = "if PCB if connected the check icon is green, otherwise is red"
export const pcb_network_desc = "PCB network connected"
...
export const services_desc = "services"
...
export const ipaddress_network_desc = "IP address of the pcA Network"
...
export const ntp_syncro_settings_desc = "With the button you can choose  NTP server using an NTP server address or use Data Sender signal"
...
export const kepware_devicenumber_desc = "the number of device"
...
export const service_status_desc = "Choose if the service is enable"
